...
export const swapNodesInPairsProblem = {
  slug: 'swap-nodes-in-pairs', number: '35', leetcodeId: 'LeetCode #24', title: '两两交换链表中的节点', difficulty: 'medium', difficultyLabel: '中等', tags: ['链表', '模拟'], languages: ['javascript'], url: 'https://leetcode.cn/problems/swap-nodes-in-pairs/',
