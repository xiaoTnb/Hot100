...
export const lruCacheProblem = {
  slug:'lru-cache', number:'38', leetcodeId:'LeetCode #146', title:'LRU 缓存（链表版）', difficulty:'medium', difficultyLabel:'中等', tags:['链表','哈希表'], languages:['javascript'], url:'https://leetcode.cn/problems/lru-cache/',
