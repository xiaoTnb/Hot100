...
export function ThreeSumVisualizer() {
  ...
  return <AlgorithmPlayer methods={threeMethods} activeMethod="sort-pointers" onMethodChange={playback.reset} playback={playback} code={threeCode} activeLineId={step.lineId}>
    <div className={`animation-canvas ${styles.canvas}`}>
      ...
      <div className={styles.direction}>
        <span data-active={step.direction === 'decrease' || undefined}><b>while · c--</b><small>b + c &gt; target</small></span>
        <span data-active={step.direction === 'match' || undefined}><b>if · 收集</b><small>b + c = target</small></span>
        <span data-active={step.direction === 'increase' || undefined}><b>for · b++</b><small>循环体结束后执行</small></span>
      </div>
